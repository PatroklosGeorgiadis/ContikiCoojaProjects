...
<simconf>
  ...
  <simulation>
    <title>simulation_erg3_p19031</title>
    ...
    <motetype>
      ...
      <description>Sky Mote Type #border-router</description>
      <source EXPORT="discard">[CONTIKI_DIR]-2.7/examples/ipv6/rpl-border-router/border-router.c</source>
      <commands EXPORT="discard">make border-router.sky TARGET=sky</commands>
      <firmware EXPORT="copy">[CONTIKI_DIR]-2.7/examples/ipv6/rpl-border-router/border-router.sky</firmware>
      <moteinterface>se.sics.cooja.interfaces.Position</moteinterface>
    ...
    <motetype>
      ...
      <description>Sky Mote Type #sky-websense</description>
    ...
    <mote>
      ...
      <interface_config>
        ...
        <x>26.505520248276806</x>
        <y>58.9676535961342</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
    ...
    <mote>
      ...
      <interface_config>
        se.sics.cooja.interfaces.Position
        <x>42.17215614654685</x>
        <y>75.87767329585425</y>
        <z>0.0</z>
      </interface_config>
      <interface_config>
        se.sics.cooja.mspmote.interfaces.MspMoteID
  ...
  <plugin>
    ...
    <plugin_config>
      ...
      <viewport>4.021284493306994 0.0 0.0 4.021284493306994 66.41376243856993 -109.12571101283285</viewport>
    </plugin_config>
    <width>400</width>
    <z>0</z>
    <height>400</height>
